...
export const zhCN: Dictionary = {
  ...
  ai: {
    ...
    suggestion: {
      ...
      logs: "梳理最近的系统日志，找出报错和异常事件",
      services: "看看有哪些服务在运行、分别监听了哪些端口",
      disk: "找出占用磁盘空间最多的目录和大文件",
      network: "查看当前的网络连接和带宽占用情况",
      processes: "列出最占 CPU 和内存的进程",
      security: "检查登录记录和失败的 SSH 登录尝试",
      docker: "看看有哪些 Docker 容器在运行、资源占用如何",
      updates: "检查系统是否有可用的软件更新",
