...
export const zhCN: Dictionary = {
  ...
  statusBar: {
    ...
    proxyOn: "代理：{name}",
    proxyOff: "代理未开启",
    proxyActiveHint: "新的远程连接将使用“{name}”，现有连接不受影响。",
    proxyDirectHint: "新的远程连接将直接连接。",
  },
  ...
  credentials: {
    ...
    keys: {
      ...
      privateKeyShownHint: "已保存的私钥以明文显示，编辑后会替换当前私钥。",
      privateKeyKeepPlaceholder: "当前私钥保持不变",
      privateKeyRequired: "请输入私钥",
      privateKeyRevealError: "无法加载已保存的私钥",
      publicKey: "公钥",
      chooseFile: "选择文件",
      import: {
        chooseFile: "选择私钥文件",
      ...
      exportDialogTitle: "导出私钥",
      exportSuccess: "私钥已导出",
      exportError: "导出私钥失败",
      exportPublicKey: "导出公钥",
      exportPublicKeyDialogTitle: "导出公钥",
      exportPublicKeySuccess: "公钥已导出",
      exportPublicKeyError: "导出公钥失败",
  ...
  tasks: {
    ...
    schedule: {
      ...
      cronPlaceholder: "0 3 * * *（分 时 日 月 周）",
      nextRun: "下次运行：{time}",
      never: "该计划永不触发",
      invalidCron: "请输入有效的 cron 表达式：分 时 日 月 周",
      nextShort: "下次 {time}",
      skipNoHost: "已跳过“{name}”的计划运行：请选择固定主机",
    },
    history: {
      title: "运行历史",
      empty: "暂无运行记录",
      ...
      clear: "清空运行历史",
      clearTitle: "清空运行历史？",
      clearConfirm: "全部任务运行历史将被永久清空，此操作无法撤销。",
      clearError: "清空运行历史失败",
      loadError: "加载运行历史失败",
      delete: "删除运行记录",
      deleteError: "删除运行记录失败",
      status: {
        running: "运行中",
        done: "已完成",
        error: "失败",
  ...
  sftp: {
    ...
    local: "本地",
    newTab: "新建标签页",
    hostSearchPlaceholder: "搜索主机",
    noMatchingHosts: "没有匹配的主机",
    openFromTerminal: "在文件面板中打开",
    currentDirectoryUnavailable:
      "终端未报告当前文件夹，已改为打开该主机的主目录。",
    ...
    bookmarks: {
      ...
      renameAction: "重命名书签",
      name: "书签名称",
      nameInvalid: "名称不能包含控制字符",
      nameTooLong: "名称不能超过 255 字节",
      error: "保存书签失败",
      renameError: "重命名书签失败",
      deleteError: "删除书签失败",
    },
  ...
  ai: {
    ...
    images: {
      ...
      tooLarge: "请选择小于 10 MB 的图片，或裁剪后重试。",
      tooMany: "每条消息最多添加 4 张图片。",
      invalid: "无法读取图片，请重新导出为 PNG 或 JPEG 后重试。",
      historyFull: "此对话的图片已达容量上限，请新建对话后发送。",
      chatTitle: "图片对话",
      hint: "可粘贴截图，需要支持图片的模型",
    },
    codeLabel: "代码",
    runCommand: "运行命令",
    runCommandDescription:
      "将在 {name} 中执行以下命令，可能修改文件或中断服务。",
    noTerminal: "未选择终端",
    stopHint: "停止助手不会终止已启动的远程命令",
    status: {
  ...
  settings: {
    ...
    json: {
      title: "JSON 设置",
      description: "集中编辑外观、显示、键盘快捷键和 AI 设置。",
      open: "打开 JSON 设置",
      openVisual: "打开图形设置",
    ...
    proxy: {
      title: "连接代理",
      description:
        "让新的远程连接通过一个代理访问。现有连接保持当前路径。代理配置会包含在加密同步和备份中。",
      add: "添加代理",
      empty: "添加代理配置，以便通过其他网络建立连接。",
      loadError: "加载代理配置失败",
      switchError: "切换代理失败",
      use: "使用代理",
      disable: "停用代理",
      ...
      form: {
        ...
        create: "创建代理",
        name: "名称",
        namePlaceholder: "办公网络代理",
        nameRequired: "请输入代理名称。",
        kind: "代理类型",
        kindHint: {
          socks5: "目标主机名由代理解析。",
          http: "基本身份验证不会加密，请仅在可信的代理网络中使用。",
        },
        host: "主机",
        ...
        username: "用户名",
        password: "密码",
        authHint: "代理不需要身份验证时可留空。",
        passwordSavedHint: "已保存密码。输入新密码可替换现有密码。",
        passwordRevealError: "显示代理密码失败",
        saveError: "保存代理失败",
      },
      delete: {
        title: "删除代理“{name}”？",
        description: "这会移除保存的代理配置，现有连接不受影响。",
        action: "删除代理",
        error: "删除代理失败",
      },
    },
    ...
    keybindings: {
      ...
      recording: "请按快捷键",
      unassigned: "未分配",
      change: "修改“{command}”的快捷键",
      disable: "禁用快捷键",
      disableCommand: "禁用“{command}”的快捷键",
      reset: "重置快捷键",
