export const en = {
  ...
  monitor: {
    ...
    memory: "Memory",
    disk: "Disk",
    cpuDetail: "Load {load} · {count} cores",
    network: "Network",
    uptime: "Up {value}",
    uptimeDh: "{d}d {h}h",
    uptimeHm: "{h}h {m}m",
  ...
  hostForm: {
    ...
    noKeysHint: "Key authentication requires an SSH key.",
    jumpHost: "Jump host",
    ...
    notes: "Notes",
    notesPlaceholder: "Purpose, maintenance window, or owner",
    create: "Create host",
  ...
  hostKey: {
    ...
    unknownDescription:
      "This is your first connection to {host}. Verify the fingerprint to confirm the server's identity before trusting it.",
    changedDescription:
  ...
  groupForm: {
    ...
    parent: "Parent group",
    noParent: "Top level",
    parentHint: "Groups can be nested.",
  ...
  credentials: {
    ...
    keys: {
      ...
      passphraseHint: "Unlocks an encrypted private key.",
      passphraseRevealError: "Failed to reveal the saved passphrase",
  ...
  snippets: {
    ...
    descriptionPlaceholder: "Purpose, requirements, or cautions",
    empty: {
  ...
  tasks: {
    ...
    new: "New task",
    newTitle: "New task",
    pickTitle: "Choose a starting point",
    editTitle: "Edit task",
    duplicate: "Duplicate",
    copyName: "{name} (copy)",
    blank: "Start from scratch",
    blankHint: "An empty task you compose step by step",
    templateLabel: "Or start from a template",
    templateSteps: "{count} steps",
    empty: {
      title: "No tasks yet",
      description:
        "Chain local commands, file transfers, and remote commands into a repeatable workflow.",
    },
    delete: {
      title: "Delete task?",
      action: "Delete task",
    ...
    template: {
      ...
      configDeploy: {
        name: "Push config",
        summary: "Upload config → remote reload",
      },
      collectLogs: {
        name: "Collect logs",
        summary: "Remote archive → download → local extract",
      },
    },
    form: {
      name: "Name",
      namePlaceholder: "Deploy frontend to production",
      description: "Description",
      descriptionPlaceholder: "Build and deploy to web-01",
      host: "Host",
      selectHost: "Select a host",
    ...
    schedule: {
      ...
      cronPlaceholder: "0 3 * * * (minute hour day month weekday)",
      nextRun: "Next run: {time}",
      never: "This schedule never runs",
      invalidCron:
        "Enter a valid cron expression: minute hour day month weekday",
      nextShort: "Next {time}",
      skipNoHost: "Skipped the scheduled run of {name}: choose a fixed host",
    },
    history: {
      title: "Run history",
      empty: "No runs yet",
      ...
      clearTitle: "Clear run history?",
      clearConfirm:
        "All task run history will be permanently cleared. This action cannot be undone.",
      clearError: "Failed to clear run history",
      loadError: "Failed to load run history",
      delete: "Delete run record",
      deleteError: "Failed to delete run record",
      status: {
        running: "Running",
        done: "Completed",
        error: "Failed",
  ...
  sftp: {
    ...
    openFromTerminal: "Open files here",
    currentDirectoryUnavailable:
      "The terminal did not report its current folder. Opened the host home folder instead.",
    ...
    bookmarks: {
      ...
      renameAction: "Rename bookmark",
      name: "Bookmark name",
      nameInvalid: "Enter a name without control characters",
      nameTooLong: "Enter a name up to 255 bytes",
      error: "Failed to save bookmark",
      renameError: "Failed to rename bookmark",
  ...
  ai: {
    ...
    images: {
      ...
      tooLarge: "Choose an image smaller than 10 MB, or crop it and try again.",
      tooMany: "Attach up to 4 images per message.",
      invalid:
        "Could not read the image. Export it as PNG or JPEG and try again.",
      historyFull:
        "This chat has reached its image storage limit. Start a new chat to send more images.",
      chatTitle: "Image chat",
      hint: "Paste screenshots with an image-capable model",
    },
    codeLabel: "Code",
    runCommand: "Run command",
    runCommandDescription:
      "The following command will run in {name}. It may modify files or interrupt services.",
    noTerminal: "No terminal selected",
    stopHint:
      "Stopping the assistant does not terminate remote commands already started",
    status: {
      "awaiting-approval": "Awaiting approval",
      "awaiting-input": "Awaiting answer",
      running: "Running",
      done: "Operation returned",
      denied: "Skipped",
  ...
  settings: {
    ...
    general: {
      ...
      display: {
        ...
        zoom: "Zoom",
        zoomHint: "The interface and terminal scale together.",
        zoomIn: "Zoom in",
        zoomOut: "Zoom out",
        zoomReset: "Reset zoom",
      },
    ...
    sync: {
      ...
      setup: {
        ...
        s3PrefixHint: "Folder path inside the bucket.",
        ...
        passphraseHint:
          "Encrypts every backup end to end. Every device needs the same passphrase to read backups. The passphrase is never sent to the storage provider.",
