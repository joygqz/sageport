export const en = {
  ...
  ai: {
    ...
    suggestion: {
      ...
      logs: "Scan recent system logs for errors and anomalies",
      services:
        "Show which services are running and the ports each one listens on",
      disk: "Find the directories and files eating the most disk space",
      network: "Show active network connections and bandwidth usage",
      processes: "List the top processes by CPU and memory usage",
      security: "Review login records and failed SSH attempts",
      docker: "Check which Docker containers are running and their resource use",
      updates: "See whether any system package updates are available",
      uptime: "Show system uptime and current load average",
    },
    newChat: "New Chat",
