...
export function GdriveIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M8.6 3h6.8l6.3 11h-6.4z" />
      <path d="M8.6 3 2.3 14l3.2 5.6L11.8 8.5z" />
      <path d="M6.7 20.6h12.1l3-5.2H9.7z" />
    </svg>
  );
}
...
export function OnedriveIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M18.5 18.5H7a4 4 0 0 1-.9-7.9 5.5 5.5 0 0 1 10.6-1.4 4.7 4.7 0 0 1 1.8 9.3z" />
    </svg>
  );
}
