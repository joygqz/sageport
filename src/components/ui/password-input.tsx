  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={cn(
          "absolute inset-y-px right-px flex w-9 items-center justify-center rounded-r-[calc(var(--radius)-1px)] text-muted-foreground transition-colors hover:text-foreground",
