...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::keys::keys_reveal_private_key,
            commands::keys::keys_export,
            commands::keys::keys_export_public,
            ...
            commands::proxies::proxies_state,
            commands::proxies::proxies_reveal_password,
            commands::proxies::proxies_create,
            commands::proxies::proxies_update,
            commands::proxies::proxies_delete,
            commands::proxies::proxies_set_active,
